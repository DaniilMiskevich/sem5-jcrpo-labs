...
import '../entities/metronome_config.dart';
...
class _PresetsScreenState extends State<PresetsScreen> {
  ...
  void _editPreset(Preset<MetronomeConfig> preset) {
    showDialog(
      context: context,
  ...
  void _deletePreset(Preset<MetronomeConfig> preset) {
    showDialog(
      context: context,
...
class PresetEditDialog extends StatefulWidget {
  ...
  final Function(Preset<MetronomeConfig>) onSave;
