...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void _navigateToCustomSoundsScreen() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const CustomSoundsScreen()),
    );
  }
            ...
            child: Column(
              children: [
                ListTile(
                  ...
                  subtitle: const Text('Manage your saved metronome configurations'),
                  trailing: const Icon(Icons.chevron_right),
